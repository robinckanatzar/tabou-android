...
public class FBMainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (firebaseAuth.getCurrentUser() != null) {
            ...
            startActivity(new Intent(getApplicationContext(), FBProfileActivity.class));
        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(FBMainActivity.this,"Successfully registered",Toast.LENGTH_LONG).show();
                            finish();
                            startActivity(new Intent(getApplicationContext(), FBProfileActivity.class));

                        }else{
                            //display some message here
                            Toast.makeText(FBMainActivity.this,"Registration Error",Toast.LENGTH_LONG).show();
                        }
